...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle){
    //Set sub title
    setText(env, title, OBFUSCATE("<b>Xtreme Modz Esp</b>"));

    //Set sub title
    setText(env, subtitle, OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                                     "<p style=\"color:red;\">Modded by @StardustXdd</p> | "
                                     "https://t.me/XtreamModz | Join Us To Be Xtreamed</p>"
                                     "</marquee></b>"));
    ...
    //Toast Example
    Toast(env,ctx,OBFUSCATE("I'm Stardust"),ToastLength::LENGTH_LONG);
